...
export const TERMS_AND_CONDITIONS: MethodTermsAndConditions = {
  send: {
    ...
    bank: [
      ...
      {
        icon: 'fees',
        text: 'The fees for bank sends are 0.3% of the sent amount plus 10 CHF if over 1000 CHF. The fees for bank sends are 1% of the sent amount plus 10 CHF if under 1000 CHF. Your bank might charge some additional fees we are not aware of.',
      },
    ],
  },
  receive: {
    ...
    bank: [
      ...
      {
        icon: 'fees',
        text: 'The fees for bank receives are 0.6% of the received amount plus 10 CHF if over 1000 CHF. The fees for bank receives are 1% of the received amount plus 10 CHF if under 1000 CHF. Your bank might charge some additional fees we are not aware of.',
      },
    ],
  },
}
